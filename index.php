...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" media="all" href="thumbpicker.css" />
	...
	<body>
		...
		<div id="ctrl">
			<form id="fo" name="picker" method="post">
		...
		<script type="text/javascript" src="jquery.thumbpicker.js"></script>
		<script type="text/javascript">
			$('.thumbpicker-frame').thumbpicker();
		</script>
	</body>
</html>